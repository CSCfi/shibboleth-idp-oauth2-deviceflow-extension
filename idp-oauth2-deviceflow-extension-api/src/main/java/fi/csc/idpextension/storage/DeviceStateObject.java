...
public class DeviceStateObject {
	...
	/**
	 * PENDING - User has not yet taken action. APPROVED - User approved the
	 * request. DENIED - User has denied the request.
	 */
	public enum State {
	 ...
	 * 
	 * @param state
	 *            State of the request, PENDING, APPROVED or DENIED.
	 * @param accessToken
	 *            Access Token for APPROVED requests.
	 * @param expiresAt
	 *            Expires At of the Access Token for APPROVED requests. EPOCH in
	 *            milliseconds.
	 */
	 ...
	 * 
	 * @param state
	 *            State of the request, PENDING or DENIED.
	 */
	 ...
	 *            JSON Object representing the class information.
	...
	public static DeviceStateObject fromJSONObject(JSONObject deviceStateObject) {
		...
		return new DeviceStateObject(State.valueOf(deviceStateObject.getAsString("state")),
				deviceStateObject.getAsString("access_token"),
				deviceStateObject.getAsNumber("expires_in") == null ? null
						: deviceStateObject.getAsNumber("expires_in").longValue());
	}
