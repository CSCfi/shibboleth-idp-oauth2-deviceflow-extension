...
/**
 * Primarily locates user code from
 * {@link DeviceUserAuthenticationContext#getUserCode()}.
 * {@link DeviceUserAuthenticationContext} is assumed to reside under
 * {@link MessageContext}. The authentication request
 * {@link OAuth2DeviceAuthenticationRequest} of the {@link MessageContext} is
 * the secondary source for the information. If both fail to produce the value,
 * a null is returned.
 */
